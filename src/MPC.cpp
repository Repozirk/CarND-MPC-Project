...
// This is the reference velocity, the vehicle should reach
double ref_v = 100;
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    //code reused from the MPC-Quizzes
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  //suggestion from the Q&A MPC-Controller: https://www.youtube.com/watch?v=bOQuhpz3YfU&feature=youtu.be
